...
const Dwellant = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Integration with Dwellant | EntireFM</title>
        <meta
          name="description"
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mt-8 mb-12 max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-light mb-6">
              Integration with Dwellant
            </h1>
            <p className="text-xl text-muted-foreground font-light mb-8">
              Delivering fast, compliant FM directly within your Dwellant workflows — no operational disruption.
            </p>
          ...
          <Card className="p-6 mb-8 bg-primary/5">
            <p className="text-sm text-muted-foreground font-light">
              <strong>Dwellant</strong> → Strong in residential & PRS
            </p>
          </Card>
