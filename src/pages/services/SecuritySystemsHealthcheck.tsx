...
const SecuritySystemsHealthcheck = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Estate Security Systems Health Check | Whole-Site Security Assessment</title>
        <meta name="description" content="Whole-site assessments covering CCTV, access control, alarms, barriers and ANPR. Expert security system health checks and compliance audits." />
      </Helmet>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <Link to="/services/access-control-advanced" className="border rounded-lg p-4 hover:border-primary transition-colors">
