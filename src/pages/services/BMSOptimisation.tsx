...
const BMSOptimisation = () => {
  ...
  return (
    <>
      <Helmet>
        <title>BMS Servicing & Optimisation | Controls Strategy | Energy Savings | EntireFM</title>
        <meta name="description" content="BMS servicing and optimisation improving building controls performance. Reducing energy waste and enhancing comfort through controls tuning and strategy improvements." />
      </Helmet>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
          <div className="lg:col-span-2">
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link to="/services/energy-optimisation-advanced" className="p-4 bg-muted/30 rounded-lg hover:bg-muted/50 transition-colors">
                ...
                <Link to="/services/ahu-fire-interlock-testing" className="p-4 bg-muted/30 rounded-lg hover:bg-muted/50 transition-colors">
