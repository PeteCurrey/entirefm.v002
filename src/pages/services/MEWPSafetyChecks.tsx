...
const MEWPSafetyChecks = () => {
  ...
  return (
    <>
      <Helmet>
        <title>MEWP & High-Level Access Safety Checks | PUWER/LOLER Compliance</title>
        <meta name="description" content="PUWER/LOLER compliance for powered access equipment. Expert MEWP inspection and work at height safety." />
      </Helmet>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <Link to="/services/lifting-equipment" className="border rounded-lg p-4 hover:border-primary transition-colors">
                    <h3 className="font-semibold mb-2">Lifting Equipment</h3>
                    <p className="text-sm text-muted-foreground">LOLER compliance</p>
                  </Link>
                  <Link to="/services/height-safety" className="border rounded-lg p-4 hover:border-primary transition-colors">
