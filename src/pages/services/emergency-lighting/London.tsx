...
const EmergencyLightingLondon = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Emergency Lighting Compliance in London | Local Testing & Statutory Compliance | EntireFM</title>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=2070&auto=format&fit=crop')` }} aria-label="Emergency lighting and fire safety systems in London high-rise commercial tower" />
