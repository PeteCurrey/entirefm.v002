...
const KitchenSuppressionSystems = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Kitchen Fire Suppression Systems | Ansul & PAFSS | Entire FM</title>
        <meta name="description" content="Expert kitchen fire suppression system installation and maintenance. Wet chemical automatic suppression for commercial catering to NFPA 17A and BS 5306 standards." />
      </Helmet>
            ...
            <aside className="space-y-6">
              ...
              <Card className="p-6">
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <li>
                    <Link to="/services/fire-suppression-systems-novec-fm200" className="text-muted-foreground hover:text-foreground transition-colors">
                      Clean Agent Suppression (FM200/Novec)
                    </Link>
                  </li>
                  <li>
                    <Link to="/services/gas-safety" className="text-muted-foreground hover:text-foreground transition-colors">
                      Gas Safety & Interlock Systems
                    </Link>
                  </li>
                  <li>
                    <Link to="/services/grease-trap-maintenance" className="text-muted-foreground hover:text-foreground transition-colors">
