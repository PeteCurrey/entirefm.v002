...
export default function ArcFlashAssessmentSheffield() {
  return (
    <>
      <Helmet>
        <title>Arc Flash Assessment & Risk Evaluation in Sheffield | EntireFM</title>
        <meta name="description" content="Arc flash assessment for Sheffield steel works, heavy industry and manufacturing. Incident energy calculations and PPE boundary mapping for high-power electrical systems." />
      ...
      <div className="min-h-screen bg-background pt-20">
        <section className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-6">
              Arc Flash Assessment in Sheffield
            </h1>
            <p className="text-xl text-white/90 font-light">
              Electrical safety analysis across South Yorkshire
            </p>
          </div>
        </section>
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-light mb-6">Arc Flash Services in Sheffield</h2>
            <div className="prose prose-lg max-w-none font-light leading-relaxed text-muted-foreground space-y-4">
              <p>
                Sheffield's industrial and manufacturing facilities require comprehensive arc flash risk assessment and safety labeling. 
                Our South Yorkshire specialists provide detailed electrical system modeling, incident energy calculations, and PPE recommendations 
                ensuring compliance with BS EN 61482 and HSE guidance across the region.
              </p>
              <p>
                Serving Sheffield and wider South Yorkshire, we deliver arc flash studies with safety labels 
          ...
          <section className="mb-12">
            <h3 className="text-2xl font-light mb-6">Contact Our Sheffield Arc Flash Team</h3>
          ...
          <section className="bg-primary/5 border border-primary/20 rounded-lg p-8 text-center">
            <h3 className="text-2xl font-light mb-4">Request Arc Flash Assessment in Sheffield</h3>
            <p className="text-muted-foreground mb-6 font-light">
              South Yorkshire specialists for arc flash studies and electrical safety analysis.
            </p>
