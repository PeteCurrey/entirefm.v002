...
export default function PowerQualityManchester() {
  return (
    <>
      <Helmet>
      ...
      <div className="min-h-screen bg-background">
        <section className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-6">Power Quality Analysis in Manchester</h1>
            <p className="text-xl text-white/90 font-light">Electrical disturbance investigation across Greater Manchester</p>
          </div>
        </section>
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-light mb-6">Power Quality Services in Manchester</h2>
            <p className="text-muted-foreground">Manchester facilities require power quality monitoring. Our engineers provide harmonic analysis and voltage disturbance investigation.</p>
          </section>
          ...
          <section className="mb-12 bg-muted/20 border border-border/50 rounded-lg p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
              <div>City Centre</div><div>MediaCityUK</div><div>Trafford Park</div><div>Salford Quays</div><div>Spinningfields</div><div>Ancoats</div>
            </div>
          </section>
          ...
          <section className="bg-primary/5 border border-primary/20 rounded-lg p-8 text-center">
            <h3 className="text-2xl font-light mb-4">Request Power Quality Analysis in Manchester</h3>
            <p className="text-muted-foreground mb-6 font-light">Greater Manchester specialists for power quality monitoring.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg"><Link to="/request-proposal">Request Proposal</Link></Button>
              <Button asChild variant="outline" size="lg"><Link to="/contact">Contact Manchester Team</Link></Button>
            </div>
          </section>
        </div>
      </div>
