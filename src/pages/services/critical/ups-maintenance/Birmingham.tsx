  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="UPS maintenance and battery replacement in Birmingham. Critical power protection for Midlands data centres, hospitals, and manufacturing facilities." />
