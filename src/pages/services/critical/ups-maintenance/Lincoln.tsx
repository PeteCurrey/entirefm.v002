  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="UPS maintenance and battery services in Lincoln. Critical power protection for Lincolnshire commercial buildings and data facilities." />
