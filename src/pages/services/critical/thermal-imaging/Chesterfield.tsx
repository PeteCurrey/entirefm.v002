...
export default function ThermalImagingChesterfield() {
  return (
    <>
      <Helmet>
        <title>Thermal Imaging Surveys in Chesterfield | EntireFM</title>
        <meta name="description" content="Thermal imaging surveys in Chesterfield. Electrical hotspot detection for North Derbyshire facilities." />
      ...
      <div className="min-h-screen bg-background">
        <section className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-6">Thermal Imaging in Chesterfield</h1>
            <p className="text-xl text-white/90 font-light">Electrical hotspot detection across North Derbyshire</p>
          </div>
        </section>
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <section className="mb-12"><h2 className="text-3xl font-light mb-6">Thermal Imaging Services in Chesterfield</h2><p className="text-muted-foreground">Chesterfield facilities require thermal imaging surveys. Our engineers provide electrical hotspot detection and energy loss investigation.</p></section>
