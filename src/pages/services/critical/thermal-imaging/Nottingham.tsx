...
export default function ThermalImagingNottingham() {
  return (
    <>
      <Helmet>
        <title>Thermal Imaging Surveys in Nottingham | EntireFM</title>
        <meta name="description" content="Thermal imaging surveys in Nottingham. Electrical hotspot detection for Nottinghamshire facilities." />
      ...
      <div className="min-h-screen bg-background">
        <section className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-6">Thermal Imaging in Nottingham</h1>
            <p className="text-xl text-white/90 font-light">Electrical hotspot detection across Nottinghamshire</p>
          </div>
        </section>
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <section className="mb-12"><h2 className="text-3xl font-light mb-6">Thermal Imaging Services in Nottingham</h2><p className="text-muted-foreground">Nottingham facilities require thermal imaging surveys. Our engineers provide electrical hotspot detection and energy loss investigation.</p></section>
