    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <section className="mb-12"><h2 className="text-3xl font-light mb-6">Thermal Imaging Services in Leeds</h2><p className="text-muted-foreground">Leeds facilities require thermal imaging surveys. Our engineers provide electrical hotspot detection and energy loss investigation.</p></section>
