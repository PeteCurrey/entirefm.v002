  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Data room audits for Manchester media, financial and PBSA IT infrastructure. Cooling, UPS and environmental monitoring assessments across Greater Manchester." />
