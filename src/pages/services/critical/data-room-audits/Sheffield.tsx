  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Data room audits for Sheffield manufacturing and industrial IT infrastructure. Power, cooling and fire suppression assessments for South Yorkshire comms rooms." />
