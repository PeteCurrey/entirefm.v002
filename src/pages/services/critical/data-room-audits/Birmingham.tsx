...
export default function DataRoomAuditsBirmingham() {
  return (
    <>
      <Helmet>
        <title>Data Room Audits in Birmingham | EntireFM</title>
        <meta name="description" content="Data room and comms room audits across Birmingham. UPS, cooling capacity and power resilience assessments for West Midlands corporate and logistics IT estates." />
      ...
      <div className="min-h-screen bg-background pt-20">
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <section className="bg-primary/5 border border-primary/20 rounded-lg p-8 text-center"><h3 className="text-2xl font-light mb-4">Request Data Room Audit in Birmingham</h3><p className="text-muted-foreground mb-6 font-light">West Midlands specialists for data room infrastructure audits.</p><div className="flex flex-col sm:flex-row gap-4 justify-center"><Button asChild size="lg"><Link to="/request-proposal">Request Proposal</Link></Button><Button asChild variant="outline" size="lg"><Link to="/contact">Contact Birmingham Team</Link></Button></div></section>
        </div>
      </div>
    </>
  );
