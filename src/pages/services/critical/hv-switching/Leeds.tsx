  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="High voltage switching and isolation services in Leeds. Safe HV operations for West Yorkshire commercial and critical facilities." />
