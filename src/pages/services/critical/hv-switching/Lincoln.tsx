  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="High voltage switching and isolation services in Lincoln. Safe HV operations for Lincolnshire commercial and critical facilities." />
