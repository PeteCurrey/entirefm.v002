  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="High voltage switching and isolation services in Birmingham. Safe HV operations for West Midlands commercial and critical facilities." />
