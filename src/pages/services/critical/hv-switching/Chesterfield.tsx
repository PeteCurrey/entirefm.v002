...
export default function HVSwitchingChesterfield() {
  return (
    <>
      <Helmet>
      ...
      <div className="min-h-screen bg-background">
        <section className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-6">
              HV Switching in Chesterfield
            </h1>
            <p className="text-xl text-white/90 font-light">
              High voltage operations across North Derbyshire
            </p>
          </div>
        </section>
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-light mb-6">HV Switching Services in Chesterfield</h2>
            <div className="prose prose-lg max-w-none font-light leading-relaxed text-muted-foreground space-y-4">
              <p>
                Chesterfield's industrial facilities require safe high voltage switching operations. 
                Our North Derbyshire HV authorized engineers provide switching procedures, isolation verification, and emergency operations 
          ...
          <section className="mb-12">
            <h3 className="text-2xl font-light mb-6">Contact Our Chesterfield HV Team</h3>
          ...
          <section className="bg-primary/5 border border-primary/20 rounded-lg p-8 text-center">
            <h3 className="text-2xl font-light mb-4">Request HV Switching in Chesterfield</h3>
            <p className="text-muted-foreground mb-6 font-light">
              North Derbyshire HV authorized engineers for safe switching operations.
            </p>
