  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="High voltage switching and isolation services in Nottingham. Safe HV operations for Nottinghamshire commercial and critical facilities." />
