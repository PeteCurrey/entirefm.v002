...
export default function LightningProtectionLondon() {
  return (
    <>
      <Helmet>
        <title>Lightning Protection Testing in London | EntireFM</title>
        <meta name="description" content="BS EN 62305 lightning protection testing in London. Earth resistance, strike path continuity, and rooftop inspections for commercial buildings across the capital." />
        ...
        <section className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-6">
              Lightning Protection Testing in London
            </h1>
            <p className="text-xl text-white/90 font-light">
              BS EN 62305 compliance testing across the capital
            </p>
          </div>
        </section>
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg max-w-none font-light leading-relaxed text-muted-foreground space-y-4">
              <p>
                London's high-rise buildings, data centres, and historic structures require specialist lightning protection compliance. 
                Our London-based engineers deliver BS EN 62305 testing across the capital, from Canary Wharf office towers to 
                Westminster heritage assets requiring sensitive protection system design.
              </p>
              <p>
                Insurance requirements for London properties increasingly mandate documented lightning protection testing. 
                We provide earth resistance measurement, strike path continuity testing, and rooftop inspection services 
                meeting landlord obligations and protecting critical infrastructure.
              </p>
            </div>
          </section>

          <section className="mb-12 bg-muted/20 border border-border/50 rounded-lg p-8">
            <h3 className="text-2xl font-light mb-6">London Service Areas</h3>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 text-muted-foreground">
                ...
                <span>24/7 emergency lightning damage response</span>
              </div>
              <div className="flex items-center gap-3 text-muted-foreground">
          ...
          <section className="bg-primary/5 border border-primary/20 rounded-lg p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6 font-light">
              Local engineers available for BS EN 62305 testing across the capital.
            </p>
