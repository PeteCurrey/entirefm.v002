...
export default function LightningProtectionLondon() {
  return (
    <>
      <Helmet>
        <title>Lightning Protection Testing in London | BS EN 62305 | EntireFM</title>
        <meta name="description" content="BS EN 62305 lightning protection testing across London. Certified inspections for high-rise buildings, data centres, and critical infrastructure." />
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          <div className="mb-12">
            <Link to="/services/critical/lightning-protection" className="text-primary hover:underline mb-8 inline-block">
