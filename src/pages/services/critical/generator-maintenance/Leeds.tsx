...
export default function GeneratorMaintenanceLeeds() {
  return (
    <>
      <Helmet>
        <title>Generator Maintenance & Load Bank Testing in Leeds | EntireFM</title>
        <meta name="description" content="Generator maintenance for Leeds financial, corporate and healthcare estates. Load bank testing, battery monitoring and emergency power validation across West Yorkshire." />
      ...
      <div className="min-h-screen bg-background pt-20">
        <section className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-6">
              Generator Maintenance in Leeds
            </h1>
            <p className="text-xl text-white/90 font-light">
              Emergency power protection across West Yorkshire
            </p>
          </div>
        </section>
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-light mb-6">Generator Services in Leeds</h2>
            <div className="prose prose-lg max-w-none font-light leading-relaxed text-muted-foreground space-y-4">
              <p>
                Leeds' commercial and industrial properties require reliable standby power generation. 
                Our West Yorkshire engineers provide comprehensive generator maintenance, load bank testing, and fuel quality management 
                ensuring operational continuity across the region.
              </p>
              <p>
                Serving Leeds and wider West Yorkshire, we maintain diesel and gas generators with planned preventive maintenance 
          ...
          <section className="mb-12">
            <h3 className="text-2xl font-light mb-6">Contact Our Leeds Generator Team</h3>
          ...
          <section className="bg-primary/5 border border-primary/20 rounded-lg p-8 text-center">
            <h3 className="text-2xl font-light mb-4">Request Generator Maintenance in Leeds</h3>
            <p className="text-muted-foreground mb-6 font-light">
              West Yorkshire engineers for generator servicing and load bank testing.
            </p>
