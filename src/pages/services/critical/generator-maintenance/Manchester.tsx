  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Generator servicing and load bank testing in Manchester. Emergency power protection for Greater Manchester commercial and critical facilities." />
