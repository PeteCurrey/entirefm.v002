...
const HeightSafety = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Height Safety Systems Inspection & Testing | EntireFM</title>
        <meta name="description" content="Work at Height Regulations compliant inspection of fall protection systems, anchor points, lifelines and height safety equipment. Expert certification services." />
        <link rel="canonical" href="https://entirefm.com/services/height-safety" />
      </Helmet>
