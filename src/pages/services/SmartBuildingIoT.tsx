...
const SmartBuildingIoT = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Smart Building IoT Sensors & Analytics | Real-Time Monitoring | EntireFM</title>
        <meta name="description" content="Smart building IoT sensors providing real-time visibility of occupancy, energy, air quality and asset performance. Wireless sensor networks with cloud analytics." />
      </Helmet>
