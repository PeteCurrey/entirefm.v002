...
const LoadingBayFumeExtraction = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Loading Bay Fume Extraction Systems | COSHH Compliance | Entire FM</title>
        <meta name="description" content="Expert loading bay fume extraction system maintenance. Protecting enclosed logistics spaces from exhaust build-up with duty/standby fan checks and sensor testing." />
      </Helmet>
            ...
            <aside className="space-y-6">
              ...
              <Card className="p-6">
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <li>
                    <Link to="/services/health-safety" className="text-muted-foreground hover:text-foreground transition-colors">
