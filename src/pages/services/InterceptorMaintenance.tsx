...
const InterceptorMaintenance = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Interceptor & Separator Maintenance | Oil & Fuel Interceptor Servicing</title>
        <meta name="description" content="Compliance servicing for oil, fuel and water interceptors used in car parks, loading bays and industrial estates. Expert interceptor maintenance and environmental compliance." />
      </Helmet>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <Link to="/services/pump-station-servicing" className="border rounded-lg p-4 hover:border-primary transition-colors">
