...
const PowerQualityAnalysis = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Power Quality Analysis | Harmonics & Voltage Testing | EntireFM</title>
        <meta name="description" content="Power quality analysis identifying harmonics, voltage dips and electrical supply anomalies affecting plant performance. Prevent equipment failures and reduce downtime." />
      </Helmet>
          ...
          <div className="lg:col-span-2">
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Link to="/services/ups-maintenance" className="p-4 bg-muted/30 rounded-lg hover:bg-muted/50 transition-colors">
