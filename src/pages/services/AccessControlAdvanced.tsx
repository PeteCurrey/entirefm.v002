...
const AccessControlAdvanced = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Advanced Access Control Systems | Card, Biometric & Integrated Solutions</title>
        <meta name="description" content="Card, fob, biometric and integrated building access solutions for controlled environments. Expert access control installation and maintenance." />
      </Helmet>
