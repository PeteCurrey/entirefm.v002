...
const CarParkFumeExtraction = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Car Park & Loading Bay Fume Extraction | CO Monitoring Compliance</title>
        <meta name="description" content="CO/NOx ventilation systems for enclosed car parks and loading bays. Expert fume extraction and workplace safety compliance." />
      </Helmet>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <Link to="/services/indoor-air-quality-testing" className="border rounded-lg p-4 hover:border-primary transition-colors">
                  ...
                  <Link to="/services/bms-integration-testing" className="border rounded-lg p-4 hover:border-primary transition-colors">
