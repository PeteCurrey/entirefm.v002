...
const FireSuppressionSystemsNovecFM200 = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Clean Agent Fire Suppression | FM200, Novec 1230 & Inergen | Entire FM</title>
        <meta name="description" content="Expert clean agent fire suppression for server rooms and data-critical spaces. FM200, Novec 1230, and Inergen system installation, testing, and maintenance." />
      </Helmet>
            ...
            <aside className="space-y-6">
              ...
              <Card className="p-6">
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <li>
                    <Link to="/services/kitchen-suppression-systems" className="text-muted-foreground hover:text-foreground transition-colors">
