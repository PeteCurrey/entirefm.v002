...
const SmartMetering = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Smart Metering & Submeter Installation | Tenant Billing | ESOS Compliance | EntireFM</title>
        <meta name="description" content="Smart metering and submeter installation for accurate consumption data across estates and tenants. Supporting ESOS, SECR compliance, and tenant billing accuracy." />
      </Helmet>
