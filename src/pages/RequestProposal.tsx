...
const RequestProposal = () => {
  ...
  const addSite = () => {
    setValue("sites", [...sites, { cityRegion: "", numberOfBuildings: "", hours24_7: false }]);
  };
                ...
                <div className="flex items-center justify-between mb-4">
                  {[1, 2, 3, 4, 5].map((step) => (
                    <div key={step} className="flex items-center">
                      ...
                      {step < 5 && (
                        <div
                          className={`h-1 w-12 md:w-20 transition-colors ${
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start space-x-3 border rounded-lg p-4">
                          <Checkbox
                            id="fireSafety"
                            checked={services.fireSafety}
                            onCheckedChange={(checked) =>
                              setValue("services.fireSafety", checked as boolean)
                            }
                          />
                        ...
                        <div className="flex items-start space-x-3 border rounded-lg p-4">
                          <Checkbox
                            id="electricalCompliance"
                            checked={services.electricalCompliance}
                            onCheckedChange={(checked) =>
                              setValue("services.electricalCompliance", checked as boolean)
                            }
                          />
                        ...
                        <div className="flex items-start space-x-3 border rounded-lg p-4">
                          <Checkbox
                            id="gasSafety"
                            checked={services.gasSafety}
                            onCheckedChange={(checked) =>
                              setValue("services.gasSafety", checked as boolean)
                            }
                          />
                        ...
                        <div className="flex items-start space-x-3 border rounded-lg p-4">
                          <Checkbox
                            id="hvacFGas"
                            checked={services.hvacFGas}
                            onCheckedChange={(checked) =>
                              setValue("services.hvacFGas", checked as boolean)
                            }
                          />
                        ...
                        <div className="flex items-start space-x-3 border rounded-lg p-4">
                          <Checkbox
                            id="ppmAsset"
                            checked={services.ppmAsset}
                            onCheckedChange={(checked) =>
                              setValue("services.ppmAsset", checked as boolean)
                            }
                          />
                        ...
                        <div className="flex items-start space-x-3 border rounded-lg p-4">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setValue("services.other", checked as boolean)
                            }
                          />
