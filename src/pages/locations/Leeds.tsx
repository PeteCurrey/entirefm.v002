...
const Leeds = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Facilities Management Leeds</title>
        <meta 
          name="description" 
          content="End-to-end FM for commercial & residential estates in West Yorkshire." 
        />
        <link rel="canonical" href="https://entirefm.com/locations/leeds" />
      </Helmet>
