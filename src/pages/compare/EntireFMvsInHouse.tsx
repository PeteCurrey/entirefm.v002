...
const EntireFMvsInHouse = () => {
  return (
    <>
      <Helmet>
        <title>EntireFM vs In-House FM | Outsource or Build Internal Team?</title>
        <meta
          name="description"
          content="Compare outsourced FM with building an in-house team. Evaluate cost structures, risk transfer, and access to specialist capabilities."
        />
        <link rel="canonical" href="https://entirefm.com/compare/entirefm-vs-in-house" />
      </Helmet>
