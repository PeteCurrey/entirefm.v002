...
const HealthSafety = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Health & Safety — Non-Negotiable Discipline | EntireFM</title>
        <meta name="description" content="Zero shortcuts, zero compromise in FM safety. Competence verification, RAMS, compliance audits, and behavioural safety culture built into every operation." />
        <link rel="canonical" href="https://entirefm.com/health-safety" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 bg-gradient-to-br from-primary/10 via-background to-background">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Button asChild size="lg">
              <Link to="/contact">Request H&S Governance Pack</Link>
            </Button>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              <Button asChild variant="outline" className="h-auto py-4">
                <Link to="/resources/engineer-standards">Engineer Standards</Link>
              </Button>
              <Button asChild variant="outline" className="h-auto py-4">
