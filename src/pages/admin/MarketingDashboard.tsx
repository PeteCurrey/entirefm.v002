      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <QuickActionCard
            ...
            onClick={() => navigate('/admin/marketing/content/new')}
            variant="primary"
          />
          <QuickActionCard
            icon={Share2}
            ...
            onClick={() => navigate('/admin/marketing/social')}
          />
          <QuickActionCard
            icon={ImageIcon}
            title="AI Media Studio"
            description="Generate images and graphics with AI"
            onClick={() => navigate('/admin/marketing/media')}
          />
          <QuickActionCard
            icon={Search}
            title="SEO Tools"
            description="Analyze and optimize page SEO"
            onClick={() => navigate('/admin/marketing/seo')}
          />
        </div>
      </div>
        ...
        <TabsContent value="content">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => navigate('/admin/marketing/content')}>
                View All
              </Button>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="social">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => navigate('/admin/marketing/social')}>
                View All
              </Button>
            </CardHeader>
            <CardContent>
              {upcomingPosts.length === 0 ? (
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <Button variant="outline" className="mt-4" onClick={() => navigate('/admin/marketing/social')}>
                    Schedule Post
                  </Button>
                </div>
              ) : (
