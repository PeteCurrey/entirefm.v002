  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => navigate('/admin/pages/new')}><Plus className="h-4 w-4 mr-2" />New Page</Button>
      </div>
        ...
        <CardContent className="p-0">
          {pages.length === 0 ? (
            <div className="text-center py-16 text-muted-foreground">
              ...
              <p>No pages yet</p>
              <Button variant="outline" className="mt-4" onClick={() => navigate('/admin/pages/new')}>Create First Page</Button>
            </div>
          ) : (
            <Table>
              <TableHeader>
