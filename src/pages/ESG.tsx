...
const ESG = () => {
  ...
  return (
    <>
      <Helmet>
        <title>ESG & Sustainability — Action, Not Greenwash | EntireFM</title>
        <meta name="description" content="Hard FM drives carbon reduction through efficiency. LED upgrades, HVAC tuning, water efficiency, and social value that shows up in KPIs." />
        <link rel="canonical" href="https://entirefm.com/esg" />
      </Helmet>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative py-20 px-4 bg-gradient-to-br from-primary/10 via-background to-background">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Button asChild size="lg">
              <Link to="/contact">Request a Sustainability Performance Review</Link>
            </Button>
          </div>
        </section>
        ...
        <section className="py-16 px-4 bg-gradient-to-br from-primary/10 via-background to-background">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Button asChild size="lg">
              <Link to="/contact">Request Your ESG Proposal</Link>
            </Button>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              <Button asChild variant="outline" className="h-auto py-4">
                <Link to="/resources/energy-esg">Energy & ESG Resource</Link>
              </Button>
              <Button asChild variant="outline" className="h-auto py-4">
                <Link to="/services/hvac">HVAC Services</Link>
              </Button>
              <Button asChild variant="outline" className="h-auto py-4">
