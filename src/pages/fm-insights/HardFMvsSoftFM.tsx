...
const HardFMvsSoftFM = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Hard FM vs Soft FM vs Specialist Engineering | EntireFM</title>
        <meta 
          name="description" 
          content="Understand the differences between Hard FM, Soft FM, and Specialist Engineering. Learn compliance requirements, example services, and why estates need an integrated approach." 
        />
        <meta name="keywords" content="hard fm, soft fm, specialist engineering, facilities management, TFM, integrated FM, building maintenance" />
        <link rel="canonical" href="https://entirefm.com/fm-insights/hard-fm-vs-soft-fm" />
      </Helmet>
      ...
      <main className="min-h-screen bg-background">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link 
                to="/fm-insights/what-is-hard-fm" 
              ...
              <Link 
                to="/fm-insights/what-is-soft-fm" 
                className="group p-6 bg-muted/30 rounded-lg hover:bg-muted/50 transition-all duration-300 hover-lift border border-transparent hover:border-primary/20"
              >
                <div className="flex items-start justify-between mb-2">
                  <h3 className="font-medium text-lg group-hover:text-primary transition-colors">
              ...
              <Link 
                to="/fm-insights/what-is-a-fire-risk-assessment" 
                className="group p-6 bg-muted/30 rounded-lg hover:bg-muted/50 transition-all duration-300 hover-lift border border-transparent hover:border-primary/20"
              >
                <div className="flex items-start justify-between mb-2">
                  <h3 className="font-medium text-lg group-hover:text-primary transition-colors">
