...
const WhatIsTFM = () => {
  ...
  return (
    <>
      <Helmet>
        <title>What Is Total Facilities Management (TFM)? | EntireFM</title>
        <meta 
          name="description" 
          content="Learn about Total Facilities Management (TFM) - the integrated service delivery model that combines Hard FM, Soft FM, and specialist engineering under single-point accountability." 
        />
        <meta name="keywords" content="total facilities management, TFM, integrated FM, facilities management outsourcing, bundled FM services, FM service delivery" />
        <link rel="canonical" href="https://entirefm.com/fm-insights/what-is-tfm" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <Link to="/fm-insights/what-is-hard-fm" className="group">
                <Card className="h-full hover:shadow-md transition-shadow">
                  <CardContent className="p-5">
                    <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors mb-2">
                      What Is Hard FM?
              ...
              <Link to="/fm-insights/what-is-soft-fm" className="group">
                <Card className="h-full hover:shadow-md transition-shadow">
                  <CardContent className="p-5">
                    <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors mb-2">
                      What Is Soft FM?
