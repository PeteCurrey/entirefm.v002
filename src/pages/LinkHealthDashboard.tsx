...
export default function LinkHealthDashboard() {
  ...
  return (
    <>
      <Helmet>
        <title>Link Health Dashboard | SEO Governance | EntireFM</title>
                        ...
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex-1">
                            <div className="text-sm font-medium mb-1">
                              From: <Link to={link.from} className="text-primary hover:underline">{link.from}</Link>
                            </div>
      ...
      {issue === 'conversion' && (
        <div className="mt-3 pt-3 border-t">
          ...
          <Button asChild size="sm" variant="outline">
            <Link to="/request-proposal">View /request-proposal</Link>
          </Button>
        </div>
      )}
