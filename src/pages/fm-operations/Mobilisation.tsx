  ...
  const keyFeatures = [
    {
      ...
      description: "Structured 30-90 day mobilisation ensuring immediate service delivery"
    },
    {
      icon: ClipboardCheck,
      title: "Compliance Gap Analysis",
      description: "Pre-mobilisation audits identifying and resolving statutory gaps"
    },
    {
      icon: Users,
      title: "TUPE Management",
      description: "Compliant staff transfer with competency validation"
    },
    {
      icon: Database,
      title: "CAFM Setup",
      description: "Asset registers, PPM schedules, and reporting from Day 1"
    }
  ];
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        <ServiceHeroSection
          ...
          title="FM Mobilisation & Contract Transition"
          description="Structured mobilisation process ensuring compliant handover and immediate service continuity from Day 1."
          stats={[
            { value: "30-90", label: "Day Programme", suffix: "d" },
            { value: "100", label: "Compliance Target", suffix: "%" },
            { value: "BS8572", label: "Aligned" },
              ...
              <div className="lg:col-span-2 space-y-12">
                  ...
                  services={[
                    {
                      ...
                      description: "Statutory inspections during mobilisation compliance catch-up",
                      url: "/services/critical/lightning-protection"
                    },
                    {
                      title: "Fire Alarm Testing",
                      description: "Statutory fire system handover and compliance verification",
                      url: "/services/fire/fire-alarms"
                    },
                    {
                      title: "Electrical Testing",
                      description: "EICR certification and electrical compliance verification",
                      url: "/services/electrical/fixed-wire-testing"
                    }
                  ]}
                />
                ...
                <section>
                  <div className="bg-primary/5 border-l-4 border-primary p-6 rounded-r-lg">
                    <h2 className="text-2xl font-light mb-4">Request Mobilisation Support</h2>
                    <p className="text-muted-foreground font-light leading-relaxed mb-6">
                      Our mobilisation service provides structured transition management—from pre-contract planning through Day 90 optimisation. We deliver compliant handovers, service continuity, and operational excellence from Day 1.
                    </p>
                    <Link 
                      to="/request-proposal" 
                      className="inline-block bg-primary text-primary-foreground px-6 py-3 rounded-lg hover:bg-primary/90 transition-colors"
                    >
                      Request Mobilisation Proposal
                    </Link>
                  </div>
                </section>
