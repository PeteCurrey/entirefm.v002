...
const PBSAEstateManchester = () => {
  ...
  return (
    <div className="min-h-screen pt-20">
      <Helmet>
        <title>Case Study: PBSA Estate Manchester | Entire FM</title>
        <meta name="description" content="How we delivered full compliance across 30+ PBSA buildings in 3 weeks, eliminating fire risk and implementing water hygiene regime with zero student disruption." />
      </Helmet>
