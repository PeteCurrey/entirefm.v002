...
const RetailComplexBirmingham = () => {
  ...
  return (
    <div className="min-h-screen pt-20">
      <Helmet>
        <title>Case Study: Retail Complex Birmingham | Entire FM</title>
        <meta name="description" content="How we eliminated trading disruption for Birmingham retail complex through 24/7 HVAC response and proactive maintenance scheduling." />
      </Helmet>
