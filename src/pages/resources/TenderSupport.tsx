  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Comprehensive tender support for facilities management RFPs. Technical response packs, compliance documents, risk mitigation plans, and mobilisation roadmaps for procurement success." 
        />
