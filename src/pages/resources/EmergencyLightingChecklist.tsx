...
import { FileText, Download, CheckCircle2, Lightbulb } from "lucide-react";
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <h1 className="text-3xl font-light">3-Hour Emergency Lighting Test Checklist</h1>
                    </div>
                  </div>
                ...
                <Card className="p-6 mb-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-sm">BS 5266-1:2016 compliance requirements and testing frequencies</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                      <span className="text-sm">Pre-test preparation and building notification procedures</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                      <span className="text-sm">Step-by-step 3-hour duration test methodology</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                      <span className="text-sm">Luminaire inspection and performance verification</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                      <span className="text-sm">Record-keeping templates and logbook requirements</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                      <span className="text-sm">Common failures and remedial action guidance</span>
                    </li>
                  </ul>
                </Card>
              ...
              <div>
                  ...
                  <Card className="p-6">
                    ...
                    <div className="border-t pt-4">
                      ...
                      <Button asChild variant="outline" className="w-full">
                        <a href="/services/emergency-lighting">View Emergency Lighting Services</a>
                      </Button>
                    </div>
                  </Card>
                )}
                ...
                <Card className="p-6 mt-6">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li>✓ BS 5266-1:2016 certified testing</li>
                    <li>✓ Out-of-hours testing to minimize disruption</li>
                    <li>✓ Digital logbook and certificate management</li>
                    <li>✓ Immediate remedial works capability</li>
                    <li>✓ Annual test reminders and scheduling</li>
                  </ul>
                </Card>
              </div>
            </div>
