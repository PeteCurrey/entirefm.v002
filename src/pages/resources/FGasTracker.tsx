...
import { FileText, Download, CheckCircle2, Wind } from "lucide-react";
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <h1 className="text-3xl font-light">F-Gas Leak Compliance Tracker</h1>
                    </div>
                  </div>
                ...
                <Card className="p-6 mb-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-sm">EU Regulation 517/2014 and UK F-Gas requirements</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                      <span className="text-sm">Leak detection frequency calculator by refrigerant charge size</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                      <span className="text-sm">Pre-populated inspection schedule templates</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                      <span className="text-sm">Multi-site asset register and certificate tracker</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                      <span className="text-sm">Automatic compliance alerts and renewal reminders</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                      <span className="text-sm">F-Gas engineer certification logging</span>
                    </li>
                  </ul>
                </Card>
              ...
              <div>
                  ...
                  <Card className="p-6">
                    ...
                    <div className="border-t pt-4">
                      ...
                      <Button asChild variant="outline" className="w-full">
                        <a href="/services/hvac">View HVAC Services</a>
                      </Button>
                    </div>
                  </Card>
                )}
                ...
                <Card className="p-6 mt-6">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li>✓ F-Gas certified refrigeration engineers</li>
                    <li>✓ Leak detection inspections to EU 517/2014</li>
                    <li>✓ Emergency refrigerant leak response</li>
                    <li>✓ Digital F-Gas logbook management</li>
                    <li>✓ Automatic compliance renewal reminders</li>
                  </ul>
                </Card>
              </div>
            </div>
