...
const VisualStandards = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Visual Standards & Presentation Gallery | Facilities Presentation Standards | EntireFM</title>
        <meta 
          name="description" 
          content="Facilities presentation standards with before & after FM results. Reception transformations, front-of-house excellence, and brand-critical finishes across all estate types." 
        />
        <link rel="canonical" href="https://entirefm.com/visual-standards" />
      </Helmet>
