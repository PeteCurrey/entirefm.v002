...
const searchData: SearchResult[] = [
  ...
  // Sectors
  { title: "Corporate Offices", url: "/sectors/offices", category: "Sectors", date: "2024-11-01" },
  { title: "Retail & Hospitality", url: "/sectors/retail-hospitality", category: "Sectors", date: "2024-11-01" },
  { title: "Industrial & Logistics", url: "/sectors/industrial-logistics", category: "Sectors", date: "2024-11-01" },
  { title: "Healthcare & Public Buildings", url: "/sectors/healthcare-public", category: "Sectors", date: "2024-11-01" },
  { title: "Hotels & Leisure", url: "/sectors/hotels-leisure", category: "Sectors", date: "2024-11-01" },
  { title: "PBSA & Student Housing", url: "/sectors/pbsa", category: "Sectors", date: "2024-11-01" },
  { title: "Universities & Education", url: "/sectors/education", category: "Sectors", date: "2024-11-01" },
  
  // Case Studies
  { title: "Corporate Office London", url: "/case-studies/corporate-office-london", category: "Case Studies", date: "2024-10-15" },
  { title: "Retail Complex Birmingham", url: "/case-studies/retail-complex-birmingham", category: "Case Studies", date: "2024-10-10" },
  { title: "Industrial Warehouse Sheffield", url: "/case-studies/industrial-warehouse-sheffield", category: "Case Studies", date: "2024-10-05" },
  { title: "PBSA Estate Manchester", url: "/case-studies/pbsa-estate-manchester", category: "Case Studies", date: "2024-09-20" },
  ...
  { title: "EICR Survival Manual", url: "/resources/eicr-manual", category: "FM Insights", description: "Electrical compliance guide", date: "2025-01-10" },
  { title: "Emergency Lighting Checklist", url: "/resources/emergency-lighting-checklist", category: "FM Insights", description: "BS 5266 testing procedures", date: "2025-01-05" },
  { title: "Legionella Governance Guide", url: "/resources/legionella-guide", category: "FM Insights", description: "ACOP L8 compliance requirements", date: "2024-12-15" },
  { title: "Compliance Calendar 2025", url: "/resources/compliance-calendar", category: "FM Insights", description: "Annual compliance schedule", date: "2024-12-01" },
  
  // Resources
  { title: "F-Gas Leak Compliance Tracker", url: "/resources/fgas-tracker", category: "Resources", description: "Track F-Gas compliance", date: "2024-11-20" },
  { title: "Audit Framework", url: "/resources/audit-framework", category: "Resources", description: "FM audit methodology", date: "2024-11-15" },
  { title: "Switching FM Provider", url: "/resources/switching-provider", category: "Resources", description: "Provider change guide", date: "2024-11-10" },
];
