    ...
    <div className="space-y-6">
      ...
      <Card className="p-6">
        ...
        <ul className="space-y-2 text-sm">
          ...
          <li>
            <Link to="/services/compliance" className="text-muted-foreground hover:text-foreground transition-colors">
              Compliance Management
            </Link>
          </li>
          <li>
            <Link to="/services/emergency" className="text-muted-foreground hover:text-foreground transition-colors">
