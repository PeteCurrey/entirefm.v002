              ...
              <header>
                ...
                <div className="flex flex-wrap gap-4">
                  <Button size="lg" asChild>
                    <Link href="/contact">Request Fabric Maintenance Proposal</Link>
                  </Button>
                  <Button size="lg" variant="outline" asChild>
                    <Link href="/contact">Log a Reactive Repair (24/7)</Link>
                  </Button>
                </div>
              </header>
              ...
              <section className="border-t border-border pt-12">
                <div className="text-center bg-charcoal text-white p-12 rounded-lg">
                  ...
                  <Button size="lg" variant="secondary" className="bg-white text-charcoal hover:bg-gray-100" asChild>
                    <Link href="/contact">Request Fabric Maintenance Support</Link>
                  </Button>
                </div>
              </section>
            </div>
