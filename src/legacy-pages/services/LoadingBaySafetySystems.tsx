            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <Link href="/services/roller-shutter-maintenance" className="border rounded-lg p-4 hover:border-primary transition-colors">
                  ...
                  <Link href="/services/dock-leveller-maintenance" className="border rounded-lg p-4 hover:border-primary transition-colors">
