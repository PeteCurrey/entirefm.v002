            ...
            <div className="lg:col-span-2 space-y-12">
              <header>
                ...
                <div className="flex flex-wrap gap-4">
                  <Button 
                    ...
                    asChild
                  >
                    <Link href="/contact">Build My PPM Programme</Link>
                  </Button>
                  <Button 
                    size="lg" 
                    variant="outline"
                    ...
                    asChild
                  >
                    <Link href="/contact">Download PPM Compliance Calendar</Link>
                  </Button>
                </div>
              </header>
              ...
              <section>
                ...
                <p className="text-lg text-muted-foreground font-light mb-6">
                  When buildings are maintained <Link href="/fm-operations/reactive-maintenance" className="text-primary hover:underline">reactively</Link>:
                </p>
              ...
              <section className="border-t border-border pt-12">
                <div className="text-center bg-charcoal text-white p-12 rounded-lg">
                  ...
                  <p className="text-lg text-gray-300 font-light mb-8 max-w-2xl mx-auto">
                    Transform <Link href="/fm-operations/reactive-maintenance" className="text-white underline hover:text-gray-200">reactive maintenance</Link> into strategic <Link href="/fm-operations/asset-lifecycle" className="text-white underline hover:text-gray-200">asset management</Link>.
                  </p>
