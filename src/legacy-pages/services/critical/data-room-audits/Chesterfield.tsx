    ...
    <>
      ...
      <div className="min-h-screen bg-background pt-20">
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <section className="bg-primary/5 border border-primary/20 rounded-lg p-8 text-center"><h3 className="text-2xl font-light mb-4">Request Data Room Audit in Chesterfield</h3><p className="text-muted-foreground mb-6 font-light">North Derbyshire specialists for data room infrastructure audits.</p><div className="flex flex-col sm:flex-row gap-4 justify-center"><Button asChild size="lg"><Link href="/request-proposal">Request Proposal</Link></Button><Button asChild variant="outline" size="lg"><Link href="/contact">Contact Chesterfield Team</Link></Button></div></section>
        </div>
      </div>
    </>
  );
