              ...
              <header>
                ...
                <div className="flex flex-wrap gap-4">
                  <Button size="lg" asChild>
                    <Link href="/contact">Request Plumbing Service</Link>
                  </Button>
                  <Button size="lg" variant="outline" asChild>
                    <Link href="/contact">Book Gas Safety Audit</Link>
                  </Button>
                </div>
              </header>
              ...
              <section>
                ...
                <div className="mt-8">
                  <Button variant="outline" asChild>
                    <Link href="/resources">Download Gas Safety Compliance Guide</Link>
                  </Button>
                </div>
              </section>
              ...
              <section className="border-t border-border pt-12">
                <div className="text-center bg-charcoal text-white p-12 rounded-lg">
                  ...
                  <Button size="lg" variant="secondary" className="bg-white text-charcoal hover:bg-gray-100" asChild>
                    <Link href="/contact">Get Your Gas Safety Plan</Link>
                  </Button>
                </div>
              </section>
            </div>
