            ...
            <div className="lg:col-span-2">
                ...
                <div className="space-y-4">
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/hvac" className="hover:text-primary transition-colors">
                        HVAC Systems
                      </Link>
                    </h3>
                  ...
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/plumbing" className="hover:text-primary transition-colors">
                        Plumbing Systems
                      </Link>
                    </h3>
                    <p className="text-sm text-muted-foreground font-light leading-relaxed mb-3">
              ...
              <section className="mb-16">
                ...
                <div className="space-y-4">
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/electrical" className="hover:text-primary transition-colors">
