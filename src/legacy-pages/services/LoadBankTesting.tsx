            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="bg-muted p-8 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Link href="/services/generator-maintenance" className="text-primary hover:text-primary/80 transition-colors flex items-center gap-2">
                    <ArrowRight className="w-4 h-4" />
                    Generator Maintenance
                  </Link>
                  <Link href="/services/ups-maintenance" className="text-primary hover:text-primary/80 transition-colors flex items-center gap-2">
                    <ArrowRight className="w-4 h-4" />
                    UPS Maintenance
                  </Link>
                  <Link href="/services/electrical" className="text-primary hover:text-primary/80 transition-colors flex items-center gap-2">
                    <ArrowRight className="w-4 h-4" />
                    Electrical Services
                  </Link>
                  <Link href="/services/data-centre-cooling-compliance" className="text-primary hover:text-primary/80 transition-colors flex items-center gap-2">
                    <ArrowRight className="w-4 h-4" />
                    Data Centre Cooling
                  </Link>
                </div>
