                ...
                <div className="space-y-4">
                  ...
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/water-hygiene" className="hover:text-primary transition-colors">
                  ...
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    ...
                    <ul className="text-sm text-muted-foreground font-light space-y-1">
                      <li>• <Link href="/services/pump-room-maintenance" className="hover:text-primary">Pump room maintenance</Link> and inspection</li>
