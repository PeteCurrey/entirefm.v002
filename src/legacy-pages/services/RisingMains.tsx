            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="bg-muted p-8 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Link href="/services/dry-riser-testing" className="text-primary hover:text-primary/80 transition-colors flex items-center gap-2">
                    <ArrowRight className="w-4 h-4" />
                    Dry Riser Testing
                  </Link>
                  <Link href="/services/sprinklers" className="text-primary hover:text-primary/80 transition-colors flex items-center gap-2">
                    <ArrowRight className="w-4 h-4" />
