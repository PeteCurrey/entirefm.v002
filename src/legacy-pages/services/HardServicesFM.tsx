            ...
            <div className="lg:col-span-2">
              ...
              <section className="mb-16">
                ...
                <div className="space-y-4">
                  ...
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/fire-safety" className="hover:text-primary transition-colors">
                        Fire Safety Systems
                      </Link>
                    </h3>
                    <p className="text-sm text-muted-foreground font-light leading-relaxed">
                  ...
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/gas-safety" className="hover:text-primary transition-colors">
                  ...
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/building-fabric" className="hover:text-primary transition-colors">
