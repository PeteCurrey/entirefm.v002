  ...
  return (
    <>
      ...
      <SchemaMarkup schema={{ 
        ...
        "@type": "Service", 
        "name": "Emergency Lighting Compliance - Derby", 
        ...
        "areaServed": ["United Kingdom", "Derby"],
        "url": "https://entirefm.com/emergency-lighting/derby",
      ...
      <BreadcrumbSchema items={[{ label: "Home", href: "/" }, { label: "Emergency Lighting Services", href: "/services/emergency-lighting" }, { label: "Derby" }]} />
      <LocalBusinessSchema 
        name="EntireFM Derby - Emergency Lighting" 
        address={{ 
          street: "Derby Office", 
          city: "Derby", 
          postalCode: "DE1 1AA", 
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?q=80&w=2070&auto=format&fit=crop')` }} aria-label="Emergency lighting system in Derby rail and aerospace manufacturing facility" />
