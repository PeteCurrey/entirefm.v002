          ...
          <div className="lg:col-span-2">
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Link href="/services/air-filtration-hepa" className="p-4 bg-muted/30 rounded-lg hover:bg-muted/50 transition-colors">
                ...
                <Link href="/services/fume-extraction-lev" className="p-4 bg-muted/30 rounded-lg hover:bg-muted/50 transition-colors">
