                ...
                <div className="space-y-4">
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/emergency-lighting" className="hover:text-primary transition-colors">
                        Emergency Lighting
                      </Link>
                    </h3>
                  ...
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/fire-alarms" className="hover:text-primary transition-colors">
                  ...
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/smoke-vent-systems" className="hover:text-primary transition-colors">
                  ...
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/stairwell-pressurisation-fans" className="hover:text-primary transition-colors">
                  ...
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/sprinklers" className="hover:text-primary transition-colors">
                    ...
                    <ul className="text-sm text-muted-foreground font-light space-y-1">
                      ...
                      <li>• <Link href="/services/dry-riser-testing" className="hover:text-primary">Dry riser testing</Link> and maintenance</li>
                  ...
                  <Card className="p-6 bg-card/50 backdrop-blur">
                    <h3 className="font-medium mb-3">
                      <Link href="/services/generator-maintenance" className="hover:text-primary transition-colors">
