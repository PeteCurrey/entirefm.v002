        ...
        <div className="container mx-auto py-8 px-4">
          ...
          <Card className="p-8 mb-12 max-w-3xl mx-auto">
            ...
            <div className="mt-6 pt-4 border-t flex flex-col sm:flex-row gap-4">
              <Link href="/why-entirefm" className="text-sm text-primary hover:underline font-medium">
                Learn more about why clients choose EntireFM →
              </Link>
              <Link href="/compare" className="text-sm text-primary hover:underline font-medium">
