            ...
            <AnimatedSection direction="up" className="max-w-4xl mt-8">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button size="lg" variant="outline" asChild>
                  <Link href="/contact">Book a Free Site Inspection</Link>
                </Button>
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="container mx-auto px-6">
            <AnimatedSection direction="up" className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <Link href="/resources/switch-playbook" className="group">
                ...
                <Link href="/compliance-diagnostic" className="group">
                  <Card className="p-6 h-full hover:border-primary/30 transition-all">
                ...
                <Link href="/resources/tender-support" className="group">
                  <Card className="p-6 h-full hover:border-primary/30 transition-all">
            ...
            <AnimatedSection direction="up" className="text-center max-w-3xl mx-auto">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10" asChild>
                  <Link href="/contact">Request Site Inspection</Link>
                </Button>
              </div>
            </AnimatedSection>
          </div>
