            ...
            <AnimatedSection direction="up" className="max-w-4xl mx-auto text-center mt-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button asChild size="lg" className="shadow-lg">
                  <Link href="/contact">Request Energy Optimisation Proposal</Link>
                </Button>
                <Button asChild variant="outline" size="lg">
                  <Link href="/tools/cost-savings-calculator">Benchmark My Building Performance</Link>
                </Button>
              </div>
            </AnimatedSection>
          </div>
            ...
            <AnimatedSection direction="up" className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button asChild size="lg" variant="secondary" className="bg-white text-charcoal hover:bg-gray-100 shadow-lg">
                  <Link href="/contact">Request Energy Proposal</Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="border-white text-white hover:bg-white/10">
                  <Link href="/services/hvac">Explore HVAC Services</Link>
                </Button>
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="container mx-auto px-6">
            <AnimatedSection direction="up" className="max-w-4xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
                <Link href="/resources/audit-framework" className="group">
                ...
                <Link href="/tools/cost-savings-calculator" className="group">
                  <Card className="p-4 h-full hover:border-primary/30 transition-all text-center">
                ...
                <Link href="/sectors/offices-corporate" className="group">
                  <Card className="p-4 h-full hover:border-primary/30 transition-all text-center">
