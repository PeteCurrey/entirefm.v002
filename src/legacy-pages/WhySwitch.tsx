            ...
            <div className="max-w-3xl">
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                <Button size="lg" asChild>
                  <Link href="/contact">Get a Switching Proposal</Link>
                </Button>
                <Button size="lg" variant="outline" asChild>
                  <Link href="/resources/switching-provider">Download the Switching Playbook</Link>
                </Button>
              </div>
            </div>
          </div>
