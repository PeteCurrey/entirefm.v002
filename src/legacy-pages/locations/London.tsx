              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <div className="bg-muted/30 p-8 rounded-lg">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <Link href="/compliance-diagnostic" className="p-4 border border-border rounded-lg hover:border-primary transition-colors">
                    ...
                    <Link href="/why-switch" className="p-4 border border-border rounded-lg hover:border-primary transition-colors">
                    ...
                    <Link href="/about" className="p-4 border border-border rounded-lg hover:border-primary transition-colors">
                    ...
                    <Link href="/resources" className="p-4 border border-border rounded-lg hover:border-primary transition-colors">
