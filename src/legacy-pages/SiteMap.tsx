            ...
            <tr key={service} className="hover:bg-muted/50">
              ...
              {locations.map((location) => (
                <td key={location} className="text-center p-2 border border-border">
                  <Link href={urlPattern(service, location)}
        ...
        <table className="w-full text-sm border-collapse">
          ...
          <tbody>
              ...
              return (
                <tr key={city} className="hover:bg-muted/50">
                  ...
                  <td className="text-center p-2 border border-border">
                    {hasFM ? (
                      <Link href={`/fm-${slug}`} className="text-primary hover:text-primary/80 hover:underline">
                        /fm-{slug}
                      </Link>
                    ) : (
                  ...
                  <td className="text-center p-2 border border-border">
                    {hasFacilitiesManagement ? (
                      <Link href={`/facilities-management-${slug}`} className="text-primary hover:text-primary/80 hover:underline">
            ...
            <tr className="hover:bg-muted/50">
              ...
              <td className="text-center p-2 border border-border">
                <Link href="/london-facilities-management" className="text-primary hover:text-primary/80 hover:underline">
