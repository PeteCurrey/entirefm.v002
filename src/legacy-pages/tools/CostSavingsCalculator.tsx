                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="pt-6 space-y-3">
                      <Button asChild className="w-full">
                        <Link href="/contact">Get a Custom PPM Strategy + Costed Plan</Link>
                      </Button>
                      <Button asChild variant="outline" className="w-full">
                        <Link href="/services/ppm">Learn About Our PPM Service</Link>
                      </Button>
                    </div>
                  </CardContent>
                </Card>
          ...
          <div className="container mx-auto px-4 text-center max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg">
                <Link href="/contact">Request a PPM Costed Plan</Link>
              </Button>
              <Button asChild variant="outline" size="lg">
                <Link href="/why-switch">Why Switch to EntireFM</Link>
              </Button>
            </div>
          </div>
        </section>
